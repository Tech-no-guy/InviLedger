  ...
  return (
    <div className="container">
      ...
      <header className="header">
        <div className="logo">InviLedger</div>
        <nav className="nav">
      ...
      <section className="hero">
        <h1>Empowering Examinations with Blockchain</h1>
        <p>
          InviLedger is a decentralized platform that harnesses blockchain technology to secure and
      ...
      <footer className="footer">
        <p>&copy; 2025 InviLedger — Revolutionizing Examinations Through Blockchain</p>
      </footer>
